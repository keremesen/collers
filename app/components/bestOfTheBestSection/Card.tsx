import { CardProps } from "@/app/types/interface";
...
const Card: React.FC<CardProps> = ({ image, title, description }) => {
  return (
    <div className="bg-slate-900 w-[361px] md:w-[394.67px] h-auto border border-slate-900 rounded-[10px] shadow-2xl shadow-[#FFFFFF40] z-50">
